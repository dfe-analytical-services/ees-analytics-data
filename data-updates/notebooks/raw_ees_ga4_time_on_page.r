...
table_name <- "catalog_40_copper_statistics_services.analytics_raw.ees_ga4_time_on_page"
...
dbExecute(sc, paste(
  ...
  table_name,
  "(date DATE, pagePath STRING, pageviews DOUBLE, sessions DOUBLE, userEngagementDuration DOUBLE)"
))
